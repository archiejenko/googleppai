        ...
        <LiveCallProvider>
            <div className="layout-shell min-h-screen flex bg-bg-canvas relative overflow-hidden selection:bg-accent/30 selection:text-white">
                ...
                >
                    ...
                    {showTrialBanner && (
                        <div className="mt-12 bg-status-warning/10 border-b border-status-warning/30 px-5 py-2 flex items-center justify-between gap-4">
                    ...
                    <main className={`flex-1 ${showTrialBanner ? '' : 'mt-12'} overflow-y-auto relative`} style={{ padding: '20px 28px 28px' }}>
                        <motion.div
